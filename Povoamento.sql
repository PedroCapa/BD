...
INSERT INTO utilizador 
	VALUES(1, 'Lucas Peixoto Silva', 'Rua dos Gritos nº1', '2012-01-17'),
		  (2, 'Luís Filipe da Costa Capa', 'Vila Verde', '1998-12-01'),
		  (3, ' Moisés Araújo Antunes', 'Maria da Fonte', '1999-04-14'),
		  (4, 'Pedro Miguel da Costa Capa', 'Vila Verde', '1998-12-01'),
          (5, 'Tiago Martins Pinheiro', 'Vila Verde', '1998-08-06'),
          (6, 'Moussa Marega', 'Vila Verde', '1991-04-14'),
          (7, 'Rodrigo Rodrigues', 'Braga', '1900-01-01'),
          (8, 'Pedro Proença', 'Lisboa', '1970-04-06'),
          (9, 'Gabriel Toledo', 'New York', '1991-05-30'),
          (10, 'Epitacio de Melo', 'New York', '1995-07-04'),
          (11, 'SAMSUNG', ' Seul Coreia do Sul', '1938-01-01'),
          (12, 'Jonas Gonçalves', 'Lisboa', '1986-05-08'),
          (13, 'Lamborghini', 'Sant Agata Bolognese','1963-10-30'),
          (14, 'Ferrari','	Maranello','1939-09-13'),
          (15, 'Apple', 'California', '1976-04-01');
